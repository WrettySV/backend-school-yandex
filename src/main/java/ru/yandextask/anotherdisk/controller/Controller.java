...
public class Controller {
    ...
    @PostMapping(path = "/imports", produces = "application/json;charset=UTF-8",consumes = "application/json;charset=UTF-8")
    public ResponseEntity imports(@RequestBody @NotNull String json) throws JsonProcessingException {
...
//    @Transactional
    ...
    public ResponseEntity updates(@RequestParam(value="date", required=true) String date){
